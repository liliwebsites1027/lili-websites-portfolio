...
const ProductShowcase = () => {
  ...
  return (
    ...
    <section className="w-full bg-[#EFE7DA] flex flex-col items-center px-0 pb-12">
      ...
      <div className="w-full max-w-[420px] bg-white rounded-[40px] py-6 pr-6 pl-3 shadow-2xl border-[6px] border-[#EFE7DA] flex items-center justify-between -mt-28 z-10 relative">
